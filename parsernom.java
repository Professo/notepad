...
//           }   
    ...
    public void take_ParseNominal2() throws Exception{ 
           String parserdata = "SELECT \n" +
                        "  r2.snum_300 as r2snum, ron.atmluno as lun1, r1.Dttransend_5 as dtrans1, r2.ACCEPTNOM_204 as accept1"
                         + ",to_char(r1.Dttransend_5,'DD.MM.RRRR HH24:MI:SS'), ron.snum \n"
                         + " ,r1.servend_16, r1.servid_15 " +
                        "  from RONTRANS2 r2,\n" +
                        "RONTRANS  r1   ,\n" +
                        "RONDO ron        \n" +
                        " where\n" +
           ...
           preparedStatement = orcs.prepareStatement("INSERT INTO ALACCEPTNOM2"
                   ...
                   + "NOM210, NOM250,NOM2100,NOM2500,NOM21000,NOM25000"
                     + ",AL2RONSNUM, AL2INKRONLINK, AL2START"//11
                   + ")"//17
                                    + "VALUES (?, ?, ?, ?, ?, " //5
                                            + "?, ?, ?, ?, ?, " //10 
                                            + "?"
